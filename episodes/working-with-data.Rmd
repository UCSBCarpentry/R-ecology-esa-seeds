...
```{r date-plot-challenge-answer, fig.alt = "Scatter plot showing the weight of the samples (in the y-axis), across time (with the date column in the x-axis)"}
surveys %>% 
  mutate(date = ymd(paste(year, month, day, sep = "-"))) %>% 
...
```{r time-series-challenge-answer, fig.alt="Line plot of the number of animals caught (in the y-axis) by date (x-axis) and sex of the animal (different colored lines for each sex)"}
