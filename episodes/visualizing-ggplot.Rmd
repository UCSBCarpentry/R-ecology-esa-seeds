...
```{r bare-plot, fig.alt = "Blank plot area after calling ggplot without specifying variables to plot"}
...
```{r plot-with-axes, fig.alt = "Blank plot area, now variable names in the x and y axes, but not showing a plot as we haven't specified how we want the data to be displayed, what type of plot to do"}
...
```{r scatter-plot, fig.alt = "Scatter plot of the weight and hindfoot_lenght variables, showing a positive relationship between the two"}
ggplot(data = complete_old, mapping = aes(x = weight, y = hindfoot_length)) +
  geom_point()
```
...
```{r change-alpha, warning=FALSE, fig.alt = "Same box plot between weight and hindfoot_lenght variables as the previous one, but now with transparency"}
ggplot(data = complete_old, mapping = aes(x = weight, y = hindfoot_length)) +
...
```{r change-color, warning=FALSE, fig.alt = "Same box plot between weight and hindfoot_lenght variables as the previous one, but now changing the color of points to blue"}
ggplot(data = complete_old, mapping = aes(x = weight, y = hindfoot_length)) +
...
```{r color-plot-type, warning=FALSE, fig.alt = "Box plot between weight (in the x-axis) and hindfoot_lenght (in the y-axis) variables as before, but now changing the color of points according to plot_type"}
...
```{r modify-points-challenge-answer, warning=FALSE, fig.alt = "Box plot between weight (in the x-axis) and hindfoot_lenght (in the y-axis) variables as before, but now changing the shape of points according to sex"}
ggplot(data = complete_old, 
...
```{r modify-color-challenge-answer, warning=FALSE, fig.alt = "Box plot between weight (in the x-axis) and hindfoot_lenght (in the y-axis) variables as before, but now changing the color of points according to year"}
ggplot(data = complete_old, 
...
```{r scale-viridis, warning=FALSE, fig.alt = "Box plot between weight (in the x-axis) and hindfoot_lenght (in the y-axis) with color of points according to plot_type, but now changing the color scale"}
ggplot(data = complete_old, mapping = aes(x = weight, y = hindfoot_length, color = plot_type)) +
  geom_point(alpha = 0.2) +
...
```{r scale-log, warning=FALSE, fig.alt = "Box plot between weight (in the x-axis) and hindfoot_lenght (in the y-axis) with color of points according to plot_type, but now modifying the scale of the x-axis to be in log 10 scale"}
ggplot(data = complete_old, mapping = aes(x = weight, y = hindfoot_length, color = plot_type)) +
  geom_point(alpha = 0.2) +
  scale_x_log10()
```
...
```{r blank-boxplot, fig.alt = "Empty plot area, using the plot_type (x-axis) and hindfoot_length (y-axis) variables"}
...
```{r boxplot, fig.alt = "Bar chart using the plot_type (x-axis) and hindfoot_length (y-axis) variables, showing the average hindfoot_length by plot_type"}
ggplot(data = complete_old, mapping = aes(x = plot_type, y = hindfoot_length)) +
...
```{r boxplot-color, warning=FALSE, fig.alt = "Same bar chart between plot_type (x-axis) and hindfoot_length (y-axis) variables as before, but now with a colored border line for each plot_type bar"}
...
```{r boxplot-fill, warning=FALSE, fig.alt = "Same bar chart between plot_type (x-axis) and hindfoot_length (y-axis) variables as before, but now with each plot_type bar in a different color"}
...
```{r boxplot-label-wrap, warning=FALSE, fig.alt = "Same bar chart between plot_type (x-axis) and hindfoot_length (y-axis) variables as before, but with wrapped labels for the x-axis, improving readability"}
ggplot(data = complete_old, mapping = aes(x = plot_type, y = hindfoot_length, fill = plot_type)) +
  geom_bar(stat = "summary", fun = "mean") +
...
```{r boxplot-points, warning=FALSE, fig.alt = "Same bar chart between plot_type (x-axis) and hindfoot_length (y-axis) variables as before, but adding a scatter plot layer on top. However, it is not as useful as all points are cluttered for each plot_type in the x-axis."}
ggplot(data = complete_old, mapping = aes(x = plot_type, y = hindfoot_length)) +
  geom_bar(stat = "summary", fun = "mean") +
  geom_point(alpha = 0.2)
```
...
```{r boxplot-jitter, warning=FALSE, fig.alt = "Same bar chart between plot_type (x-axis) and hindfoot_length (y-axis) variables as before, with a scatter plot layer on top for the same variables. Now adding random noise in the x-axis so points don't clutter in the same place."}
ggplot(data = complete_old, mapping = aes(x = plot_type, y = hindfoot_length)) +
  geom_bar(stat = "summary", fun = "mean") +
...
```{r global-color, warning=FALSE, fig.alt = "Same bar chart between plot_type (x-axis) and hindfoot_length (y-axis) variables as before, with a scatter plot layer on top, but now each bar has a different color while points have all the same color."}
ggplot(data = complete_old, mapping = aes(x = plot_type, y = hindfoot_length, fill = plot_type)) +
  geom_bar(stat = "summary", fun = "mean") +
  geom_jitter(alpha = 0.2)
```
...
```{r geom-color, warning=FALSE, fig.alt = "Same bar chart between plot_type (x-axis) and hindfoot_length (y-axis) variables as before, with a scatter plot layer on top, but now each bar has the same color while points have different colors for each plot_type."}
ggplot(data = complete_old, mapping = aes(x = plot_type, y = hindfoot_length)) +
  geom_bar(stat = "summary", fun = "mean") +
...
```{r reverse-layers, warning=FALSE, fig.alt = "Same bar chart as before, but now the bars are on top of the points of the scatter plot"}
ggplot(data = complete_old, mapping = aes(x = plot_type, y = hindfoot_length)) +
...
```{r fill-na, warning=FALSE, fig.alt = "Same bar chart as before, but now boxes are transparent and only have black line as a border."}
ggplot(data = complete_old, mapping = aes(x = plot_type, y = hindfoot_length)) +
  geom_jitter(aes(color = plot_type), alpha = 0.2) +
...
```{r error-bars, warning = F, fig.alt = "Bar chart using the plot_type (x-axis) and hindfoot_length (y-axis) variables, showing the average hindfoot_length by plot_type. Now adding error bars for each plot_type."}
ggplot(data = complete_old, mapping = aes(x = plot_type, y = hindfoot_length, fill = plot_type)) +
  geom_bar(stat = "summary", fun = "mean") +
...
```{r violin-challenge-answer, warning=FALSE, fig.alt = "Violin plot on top of a jittered scatter plot showing the distribution of data between the plot_type (x-axis) and hindfoot_length (y-axis) variables."}
ggplot(data = complete_old, 
...
```{r violin-challenge-answer-2, warning=FALSE, fig.alt = "Violin plot on top of a jittered scatter plot showing the distribution of data between the plot_type (x-axis) and hindfoot_length (y-axis) variables. Data has different colors according to plot_type."}
ggplot(data = complete_old, 
       mapping = aes(x = plot_type, 
                     y = hindfoot_length,
                     color = plot_type)) +
...
```{r, warning=FALSE, fig.alt = "Bar plot with border but with fill transparent on top of a jittered scatter plot between plot_type (x-axis) and hindfoot_length (y-axis), and each point for the scatter plot is color according to plot_type."}
...
```{r theme-bw, warning=FALSE, fig.alt = "Same plot as before, but now changing the theme to have a white background."}
myplot + theme_bw()
```
...
```{r text-size, warning=FALSE, fig.alt = "Same plot as before, but now setting the axes titles size to 14, making them bigger."}
myplot +
  theme_bw() +
...
```{r element-blank, warning=FALSE, fig.alt = "Same plot as before, but now without grid lines for the x axis."}
myplot +
  theme_bw() +
  theme(axis.title = element_text(size = 14), 
...
```{r legend-remove, warning=FALSE, fig.alt = "Same plot as before, but without a legend."}
myplot +
  theme_bw() +
  theme(axis.title = element_text(size = 14), 
        panel.grid.major.x = element_blank(), 
...
```{r labels, warning=FALSE, fig.alt = "Same plot as before, but now adding a title and more descriptive labels for the axes."}
myplot +
  theme_bw() +
  theme(axis.title = element_text(size = 14), 
        legend.position = "none") +
...
```{r customizing-challenge-answer, warning=FALSE, fig.alt = "Same plot as before, but now adding a title, a subtitle, and more descriptive labels for the axes."}
myplot +
  theme_bw() +
...
```{r facet-wrap, warning=FALSE, fig.alt = "Same plot as before, but now including facets (also called subplots) for each sex."}
myplot +
  theme_bw() +
  theme(axis.title = element_text(size = 14), 
        legend.position = "none", 
